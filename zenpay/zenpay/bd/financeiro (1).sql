...
CREATE TABLE `contas_bancarias` (
  ...
  CONSTRAINT `contas_bancarias_ibfk_1` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id_usuario`) ON DELETE CASCADE
...
CREATE TABLE `despesas_usuario` (
  ...
  CONSTRAINT `despesas_usuario_ibfk_1` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id_usuario`) ON DELETE CASCADE,
  CONSTRAINT `despesas_usuario_ibfk_2` FOREIGN KEY (`conta_id`) REFERENCES `contas_bancarias` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `receitas_usuario` (
  ...
  `usuario_id` int(11) UNSIGNED DEFAULT NULL,
  `valor` decimal(10,2) DEFAULT NULL,
  `conta_destino_id` int(11) UNSIGNED DEFAULT NULL,
  `categoria` varchar(50) DEFAULT NULL,
  `data_recebimento` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `usuario_id` (`usuario_id`),
  KEY `conta_destino_id` (`conta_destino_id`),
  CONSTRAINT `receitas_usuario_ibfk_1` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id_usuario`) ON DELETE CASCADE,
  CONSTRAINT `receitas_usuario_ibfk_2` FOREIGN KEY (`conta_destino_id`) REFERENCES `contas_bancarias` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
--
