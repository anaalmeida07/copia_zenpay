    ...
    <div class="conteudo">
        ...
        <form method="POST" action="cadastro.php" class="form login">
            ...
            <div class="input-container ic3">
                <label for="login-username" class="placeholder">User</label><br>
                <input id="login-username" class="input" type="text" name="username" placeholder="Crie um user personalizado!" required />
            </div>
