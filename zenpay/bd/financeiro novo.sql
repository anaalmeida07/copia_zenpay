...
--
-- Host: 127.0.0.1
-- Tempo de geração: 06/12/2024 às 05:07
...
(6, 33, 'Nubank', ',jbhil', 123456.00, NULL);
...
(9, 33, 1234.00, 6, 'vghj', '2024-12-06 01:05:42');
...
(0, 33, 1234.00, 6, 'Salário', '2024-12-06 01:05:33');
...
INSERT INTO `usuarios` (`usuario_id`, `nome`, `email`, `username`, `senha`) VALUES
...
(30, 'joana', 'joana@joana.com', '', '$2y$10$tZU3dBPTIhZ0vxx50rBfkec08msIqqK1y01fD4gQ2jNgTpjnPo61G'),
(31, 'ana', 'ana@ana.com', '', '$2y$10$J9ASKJhDUnodeKKG1GbvDOtn9FsB13.ATsKySpDXiQtcXIlDdiMFu'),
(32, 'ana', 'ana@ana.com', '', '$2y$10$ylCNtvzg8Sli943a8QDBfewqrmdBZ6YCLSDg9EZPmakyBHIHSVN8m'),
(33, 'ana', 'ana@ana.com', 'anaalmeida07', '$2y$10$KWJmL2iwo049MaY.0y3M0uedsIvXwnn98GZe3yX7p3ID9Ke1wqjIu'),
(34, 'anaTeste', 'ana@ana.com', 'ana01', '$2y$10$0XMS.GJHYZyA8XTf7yFDYuVyue0X7AVPp48Let3Wnl24vJ2y6y4UO'),
(35, 'anaTetse2', 'ana@ana.com', 'ana02', '$2y$10$tEf8jR2Xx1Qh9xwSVS/7TuURGY87pAOgIC1f87I9xlgPSMBiHZEv6'),
(36, 'ana', 'ana@ana.com', 'ana03', '$2y$10$WIZSXuPF2XRqA6rKlBgrm..wOK.3YtVOl9xcD4MXxnOpCLxgAa/CG'),
(37, 'ana', 'ana@ana.com', 'ana04', '$2y$10$ah7jZ8UZQ3VgjqynClY68eqAM0qE9ye8WwQ0QLWnTI1hvuYjHcZrm'),
(38, 'ana', 'ana@ana.com', 'ana05', '$2y$10$XudvOkoUe9/7J7ziJeMUnuRLD0rDlutX8ow2IeatVc8BGgXDgvXSq'),
(39, 'ana', 'ana@ana.com', 'ana06', '$2y$10$LXyFO9OkRhzr1VQJT7kZ2eUlhRMDNQDvKUDpo4FVQedt71FLeYJra'),
(40, 'ana', 'ANA@ANA.COM', 'ana07', '$2y$10$AFp6aJ3kt/YHCZIVoo4W0O07mabJpFULYuf6QivCw/pCfryUaPDoO'),
(41, 'ana', 'ana@ana.com', 'ana001', '$2y$10$olhcmg5WZKFfNFvpuOBR2efsSz/tMUms5b63qPuQTMGMx91qX1wv.'),
(42, 'ana', 'ANA@ANA.COM', 'ana002', '$2y$10$hlAI6u.6mKhHeWRNxImC3.gy2hLGA19oLa7Y0sjDMXcDnuelNej3O'),
(43, 'ana', 'ana@ana.com', 'ana49', '$2y$10$bi7NDtwC94tZrAflOtpyEuzAs5VallY9uirz.J6Ei0qG3H7CbA9li'),
(44, 'anateste4000', 'ana@ana.com', 'ana1550', '$2y$10$Mgc4A8oI9zojJBUhJksLbuxkxkf0Ka5z9ADhSBvG7YH8PtWY9RS9C');
...
--
ALTER TABLE `contas_bancarias`
  MODIFY `conta_bancaria_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT de tabela `despesas_usuario`
--
ALTER TABLE `despesas_usuario`
  MODIFY `despesas_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
